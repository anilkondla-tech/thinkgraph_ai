    ...
    extend: {
      ...
      keyframes: {
        ...
        rotate3d: {
          ...
          "15%": { transform: "rotateX(12deg) rotateY(-15deg) rotateZ(5deg)" },
          "30%": { transform: "rotateX(-8deg) rotateY(10deg) rotateZ(-3deg)" },
          "45%": { transform: "rotateX(6deg) rotateY(18deg) rotateZ(-6deg)" },
          "60%": { transform: "rotateX(-12deg) rotateY(-8deg) rotateZ(4deg)" },
          "75%": { transform: "rotateX(10deg) rotateY(-14deg) rotateZ(-5deg)" },
          "90%": { transform: "rotateX(-5deg) rotateY(12deg) rotateZ(3deg)" },
